...
LOCAL_EXPORT_C_INCLUDES := ../../ffmpeg-android-builder/ffmpeg/android/armv6/include

LOCAL_EXPORT_LDLIBS := ../../ffmpeg-android-builder/ffmpeg/android/armv6/libffmpeg-v${FFMPEG_VERSION}.so
