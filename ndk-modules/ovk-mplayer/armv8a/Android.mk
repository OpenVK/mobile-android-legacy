...
LOCAL_EXPORT_C_INCLUDES := ../../ffmpeg-android-builder/ffmpeg/android/armv8-a/include

LOCAL_EXPORT_LDLIBS := ../../ffmpeg-android-builder/ffmpeg/android/armv8-a/libffmpeg-v${FFMPEG_VERSION}.so
