...
public class XRelativeLayout extends RelativeLayout implements OnKeyboardStateListener {

  private OnKeyboardStateListener listener;
  private int prevh = -1;
  private int prevw = -1;
  public XRelativeLayout(Context paramContext) {
    super(paramContext);
  ...
  public XRelativeLayout(Context paramContext, AttributeSet paramAttributeSet) {
