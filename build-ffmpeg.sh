#!/bin/bash
#  FFmpeg 0.7.1 & 4.0.4 for Android automatic build script using builder by Tinelix
...
cd builder
chmod -R 0777 . && chmod +x ./build-android-2.6.sh && chmod +x ./build-android-0.7.1.sh && chmod +x ./build-android-0.8.5.sh
...
if [[ -z $1 ]]; then
    ...
    ./build-android-0.7.1.sh armv6 r7
    ./build-android-0.7.1.sh armv7 r7
elif [ $1 == "0.8.5" ]; then
    ...
    echo;
    echo "[ERROR] Wrong argument: ./build-ffmpeg.sh [version == '2.6' or '0.7.1' or '0.8.5']"
    exit 1;
fi;
