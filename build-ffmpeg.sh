#!/bin/bash
#  FFmpeg 0.11.5 & 3.1.4 for Android automatic build script using builder by Tinelix
...
if [[ -z $1 ]]; then
    # Build FFmpeg 0.11.5 & 3.1.4 for 32-bit architecture
    ./build-android-0.11.5.sh armv6 r8e
    ./build-android-0.11.5.sh armv7 r8e
    ./build-android-0.11.5.sh x86 r8e
    # FFmpeg 0.11.5 not buildable under ARMv8a 64-bit and x64
    ./build-android-3.1.4.sh armv8a
elif [ $1 == "0.11.5" ]; then
    ./build-android-0.11.5.sh armv6 r8e
    ./build-android-0.11.5.sh armv7 r8e
    ./build-android-0.11.5.sh x86 r8e
elif [ $1 == "0.11.5-r6" ]; then
    ./build-android-0.11.5.sh armv6 r6
    ./build-android-0.11.5.sh armv7 r6
    ./build-android-0.11.5.sh x86 r6
elif [ $1 == "3.1.4" ]; then
    ./build-android-3.1.4.sh armv8a
    ...
    echo;
    echo "[ERROR] Wrong argument: ./build-ffmpeg.sh [version == '3.1.4' or '0.11.5' or '0.11.5-r6']"
    exit 1;
fi;
...
if [[ -z $1 ]]; then
    ...
    cp ./ffmpeg-0.11.5/android/armeabi/libffmpeg.so ../../../app/src/main/jniLibs/armeabi
    cp ./ffmpeg-0.11.5/android/armeabi-v7a/libffmpeg.so ../../../app/src/main/jniLibs/armeabi-v7a
    cp ./ffmpeg-0.11.5/android/x86/libffmpeg.so ../../../app/src/main/jniLibs/x86
elif [ $1 == "0.11.5" ]; then
    cp ./ffmpeg-0.11.5/android/armeabi/libffmpeg.so ../../../app/src/main/jniLibs/armeabi
    cp ./ffmpeg-0.11.5/android/armeabi-v7a/libffmpeg.so ../../../app/src/main/jniLibs/armeabi-v7a
    cp ./ffmpeg-0.11.5/android/x86/libffmpeg.so ../../../app/src/main/jniLibs/x86
