...
ANDROID_NDK_HOME=${ANDROID_NDK_R10E} ./build-android-3.1.4.sh armv8a r10e
ANDROID_NDK_HOME=${ANDROID_NDK_R8E} ./build-android-3.1.4.sh armv7 r8e
ANDROID_NDK_HOME=${ANDROID_NDK_R8E} ./build-android-3.1.4.sh armv6 r8e
ANDROID_NDK_HOME=${ANDROID_NDK_R8E} ./build-android-3.1.4.sh x86 r8e
