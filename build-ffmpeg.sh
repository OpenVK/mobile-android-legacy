#!/bin/bash
#
#  FFmpeg 2.2.4 for Android automatic build script using builder by Tinelix
#
...
ANDROID_NDK_HOME=${ANDROID_NDK_R10E} ./build-android-2.2.4.sh armv8a r10e
ANDROID_NDK_HOME=${ANDROID_NDK_R8E} ./build-android-2.2.4.sh armv7 r8e
ANDROID_NDK_HOME=${ANDROID_NDK_R8E} ./build-android-2.2.4.sh armv6 r8e
ANDROID_NDK_HOME=${ANDROID_NDK_R8E} ./build-android-2.2.4.sh x86 r8e
